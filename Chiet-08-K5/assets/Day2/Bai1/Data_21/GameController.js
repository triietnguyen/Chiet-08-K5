    ...
    animateNumber(label, currentValue, targetValue, prefix = "", type, owner) {
        if (currentValue !== targetValue) {
            ...
            switch (type) {
                case "health":
                    if (owner === "player") {
                        this.displayedPlayerHealth = currentValue;
                    } else if (owner === "enemy") {
                        this.displayedEnemyHealth = currentValue;
                    }
                    break;
                case "energy":
                    if (owner === "player") {
                        this.displayedPlayerEnergy = currentValue;
                    } else if (owner === "enemy") {
                        this.displayedEnemyEnergy = currentValue;
                    }
                    break;
            }
